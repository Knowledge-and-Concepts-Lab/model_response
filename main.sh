...
python main.py --exp_name 'feature_and_concept' --model_type 'gpt' --model_name 'text-davinci-003' --input './examples/feature_and_concept/features.csv' './examples/feature_and_concept/animals.csv' --output './examples/feature_and_concept/response.csv' --batch_size 256
